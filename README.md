...
Some applications like steam need to close separately, because it hangs if you just use close window command, might also be a problem with other programs that closes to tray
